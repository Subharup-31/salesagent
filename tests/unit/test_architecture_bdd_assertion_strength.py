...
_HASATTR_ALLOWLIST: set[str] = {
    ...
    "bdd/steps/domain/uc004_delivery.py:1579 then_has_deliveries_field",
...
_COUNT_ONLY_ALLOWLIST: set[str] = {
    "bdd/steps/generic/then_success.py:25 then_response_status",
    ...
    "bdd/steps/domain/uc004_delivery.py:1107 then_has_metrics",
    "bdd/steps/domain/uc004_delivery.py:1128 then_has_packages",
    "bdd/steps/domain/uc004_delivery.py:1158 then_has_mb_status",
    "bdd/steps/domain/uc004_delivery.py:1380 then_exponential_backoff",
    "bdd/steps/domain/uc004_delivery.py:1395 then_retry_with_backoff",
    "bdd/steps/domain/uc004_delivery.py:1670 then_packages_include_breakdown",
    "bdd/steps/domain/uc004_delivery.py:1697 then_packages_limited",
    "bdd/steps/domain/uc004_delivery.py:1729 then_packages_include_field",
    "bdd/steps/domain/uc004_delivery.py:1742 then_packages_include_two",
    ...
    "bdd/steps/domain/uc011_accounts.py:2012 then_governance_agents_stored",
    ...
    # FIXME(salesagent-beq4): replace count-only check with element-level assertion
    "bdd/steps/domain/uc_get_products_inventory.py:161 then_has_products",
}
